...
app.get('/member', (req, res) => {
  const members = [
    ...
    { id: 11, position: 'general', name: 'Ichiro Yamada', email: 'ichiro.yamada@example.com', status: true },
    { id: 12, position: 'admin', name: 'Nijiro Yamada', email: 'nijiro.yamada@example.com', status: false },
